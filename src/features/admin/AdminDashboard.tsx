...
export const AdminDashboard: React.FC = () => {
  ...
  const monthlyVolumeData = [
    ...
    { month: 'Sep', negotiations: 18, agreements: 13 },
  ];
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-8">
      ...
      {/* Asymmetric Metric Strip replacing the 4 equal cards */}
            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="text-xs font-mono text-slate-400 dark:text-slate-500">#{neg.id}</span>
